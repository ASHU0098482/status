...
public:
    MemoryPatch();
    ~MemoryPatch();
    static MemoryPatch createWithHex1(const char *libraryName, uintptr_t address, std::string hex, bool useMapCache=true);
    static MemoryPatch createWithHex1(uintptr_t absolute_address, std::string hex);
